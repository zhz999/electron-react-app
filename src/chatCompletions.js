...
const credential = new AzureKeyCredential("92fd307677e6468eb259f1a549f0e4e8");
...
(async () => {
    ...
    const result = await client.getChatCompletions(deploymentId, messages,{n:1});
    for (const choice of result.choices) {
        const {message,finishReason,delta} = choice
